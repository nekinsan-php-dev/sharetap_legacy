...
class HomeController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        $plans = Plan::with(['currency', 'planFeature', 'hasZeroPlan'])->where('status',1)->get();
    ...
    public function refundPolicy(){
        ...
        return \view('front.refund-policy', compact('plans', 'setting', 'features', 'testimonials', 'aboutUS', 'metas', 'faqs'));
    }
