...
<div style="background:url('https://nekinsan.co/sharetap/public/assets/images/bg-shapes.png'); margin-top: -16px;padding-top: 2rem;">
    <div class="container">
         <div class="p-4 text-center" >
                    <h4 class="card-title mb-0 d-inline-block csnton-tit-other w-100">Upload Images & Other Details</h4>
        ...
        <form action="{{ route('card.temp-store-step-three-store') }}" method="post" enctype="multipart/form-data" style="padding: 29px;">
            @csrf
                    ...
                    <div class="p-4 mt-2">
                        <div class="form-group mb-7 vcard-template">
                            <div class="row" style="position:relative;">
                                        ...
                                        <div class="d-block">
                                            <div class="images-picker">
                                                <div class="image previewImage" id="coverPreview"
                                                     style="background-image: url('https://nekinsan.co/sharetap/public/assets/images/default_cover_image.jpg');">
                                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3" io-image-input="true">
                                        <div class="new-custon-sac-profil">
                                            <div class="image-picker">
                                                <div class="image previewImage" id="exampleInputImage"
                                                     style="background-image: url('https://nekinsan.co/sharetap/public/web/media/avatars/user2.png')">
                                                </div>
                                                <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                      data-bs-toggle="tooltip" data-placement="top"
                                                      data-bs-original-title="Change Profile">
                                                    <label>
                                                        <svg class="svg-inline--fa fa-pen" id="profileImageIcon" aria-hidden="true"
                                                             focusable="false" data-prefix="fas" data-icon="pen" role="img"
                                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path
                                                                fill="currentColor"
                                                                d="M362.7 19.32C387.7-5.678 428.3-5.678 453.3 19.32L492.7 58.75C517.7 83.74 517.7 124.3 492.7 149.3L444.3 197.7L314.3 67.72L362.7 19.32zM421.7 220.3L188.5 453.4C178.1 463.8 165.2 471.5 151.1 475.6L30.77 511C22.35 513.5 13.24 511.2 7.03 504.1C.8198 498.8-1.502 489.7 .976 481.2L36.37 360.9C40.53 346.8 48.16 333.9 58.57 323.5L291.7 90.34L421.7 220.3z"></path></svg>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mt-3">
                                                    <label class="delivery_address">Shipping Address</label>
                                                    <textarea class="form-control" name="delivery_address" placeholder="Enter your shipping address"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        document.getElementById('profile_image').addEventListener('change', function (event) {
            ...
            const previewImage = document.getElementById('exampleInputImage');
    ...
    <script>
        document.getElementById('coverImg').addEventListener('change', function (event) {
            const input = event.target;
            const previewImage = document.getElementById('coverPreview'); // Corrected ID
