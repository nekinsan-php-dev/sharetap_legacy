                                ...
                                <form action="{{ route('user.basic-info.update') }}" method="post" style="padding: 29px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="first_name" name="first_name"
                                                    ...
                                                    value="{{ $user->vcard->first_name ?? '' }}" required>
                                                @error('first_name')
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="last_name" name="last_name"
                                                    ...
                                                    value="{{ $user->vcard->last_name ?? '' }}" required>
                                                @error('last_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="gender" name="gender" required>
                                                    ...
                                                    <option {{ $user->vcard->gender == 'male' ? 'selected' : '' }}
                                                        value="male">Male</option>
                                                    <option {{ $user->vcard->gender == 'female' ? 'selected' : '' }}
                                                        value="female">Female</option>
                                                    <option {{ $user->vcard->gender == 'other' ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="alternate_email"
                                                    name="alternate_email" placeholder="Enter Alternate Email"
                                                    value="{{ $user->vcard->alternative_email ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="d-flex">
                                                <label for="enable_enquiry_form" class="form-label">Enable Inquiry
                                                    Form:</label>
                                                <div class="mx-4">
                                                    <div
                                                        ...
                                                        <div class="fv-row d-flex align-items-center">
                                                            <input class="form-check-input mt-0 "
                                                                ...
                                                                id="enableEnquiryForm" name="enable_enquiry_form"
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="d-flex">
                                                <label for="enable_download_qr_code" class="form-label">Enable Download QR
                                                    Code:</label>
                                                <div class="mx-4">
                                                    <div
                                                        class="form-check form-switch form-check-custom form-check-solid form-switch-sm col-6">
                                                        <div class="fv-row d-flex align-items-center">
                                                            <input class="form-check-input mt-0 "
                                                                id="enableDownloadQrCode"
                                                                {{ $user->vcard->enable_download_qr_code == 1 ? 'checked' : '' }}
                                                                name="enable_download_qr_code" type="checkbox"
                                                                value="1">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="mx-3">
                                                    <div
                                                        class="form-check form-switch form-check-custom form-check-solid form-switch-sm col-6">
                                                        <div class="fv-row d-flex align-items-center">
                                                            <input class="form-check-input mt-0 " id="enableQrCode"
                                                                {{ $user->vcard->show_qr_code == 1 ? 'checked' : '' }}
                                                                name="show_qr_code" type="checkbox" value="1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="d-flex">
                                                <label for="enable_addcontact" class="form-label">Enable Add to
                                                    contact:</label>
                                                <span data-bs-toggle="tooltip" class="mb-3" data-placement="top"
                                                    data-bs-original-title="By enabling this the contact details will be visible on all your Vcards ">
                                                    <svg class="svg-inline--fa fa-circle-question ml-1 mx-1 general-question-mark"
                                                ...
                                                <div class="mx-4">
                                                    <div
                                                        class="form-check form-switch form-check-custom form-check-solid form-switch-sm col-6">
                                                        <div class="fv-row d-flex align-items-center">
                                                            <input class="form-check-input mt-0 " id="enableContact"
                                                                {{ $user->vcard->enable_contact == 1 ? 'checked' : '' }}
                                                                name="enable_contact" type="checkbox" value="1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="d-flex">
                                                ...
                                                <span data-bs-toggle="tooltip" class="mb-3" data-placement="top"
                                                    data-bs-original-title="By enabling this, the WhatsApp Share button will be visible on all your VCards">
                                                    <svg class="svg-inline--fa fa-circle-question ml-1 mx-1 general-question-mark"
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="circle-question" role="img"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                ...
                                                <div class="mx-4">
                                                    <div
                                                        class="form-check form-switch form-check-custom form-check-solid form-switch-sm col-6">
                                                        <div class="fv-row d-flex align-items-center">
                                                            <input class="form-check-input mt-0 " id="whatsappShare"
                                                                {{ $user->vcard->whatsapp_share == 1 ? 'checked' : '' }}
                                                                name="whatsapp_share" type="checkbox" value="1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
