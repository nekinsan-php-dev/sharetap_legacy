            ...
            <div class="card-body p-0">
                <div class="row p-2">
                     <div class="col-md-12 p-2">
                        <form method="POST" action="{{ route('user.services.update.data',$service->id) }}"
                            ...
                            <div class="mb-5"><label for="description" class="form-label required">Description:</label>
                                <textarea class="form-control" placeholder="Enter Short Description"
                                          ...
                                          id="description">{{ $service->description }}</textarea></div>
                                ...
                                <div class="d-block">
                                    <div class="image-picker">
                                        <div class="image previewImage" id="servicePreview"
                                             style="background-image: url({{ $service->service_icon }})"></div>
