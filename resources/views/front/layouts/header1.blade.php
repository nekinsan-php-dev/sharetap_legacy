        ...
        <div class="container" id="frontHomeTab">
            <div class="row align-items-center justify-content-between">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light justify-content-end">
                        ...
                        <div class="navbar-collapse justify-content-end new-home-nav d-none" id="navbarNav">
                            <ul class="navbar-nav align-items-lg-center" data-turbo="false">
                                ...
                                <li>
                                        <a class="btn btn-warning fs-18 d-lg-block d-none" style="margin-right:5px;" href="{{ route('card.create') }}"
                                            role="button" data-turbo="false">Create New Card</a>
                                    </li>
                                    <li>
                                        <a class="btn btn-white fs-18 d-lg-block d-none" href="{{ route('user.login') }}"
                                    ...
                                    @if(getLogInUser()->hasrole('user'))
                                        <li>
                                            <a class="btn btn-white fs-18 d-lg-block d-none"
                                               href="{{ route('user.dashboard.index') }}" role="button"
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-5 text-end order-lg-2 order-1 pe-lg-2 pe-0 ps-0 d-lg-none">
                    ...
                    @if (empty(getLogInUser()))
                        <a class="btn btn-white fs-18 me-sm-2" href="{{ route('user.login') }}" data-turbo="false"
                            role="button">
