    ...
    <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
        ...
        <div class="p-5">
            <div class="mb-5">
                ...
                {{ Form::select('type',[0 => __('messages.select_payment_type')] + App\Models\Product::PAYMENT_METHOD, null,['class' => 'form-control form-select','data-control'=>"select2" ,'id' => 'productPaymentType', 'wire:ignore']) }}
            </div>
