            ...
            <div class="card-body border-top p-3">
                ...
                <div class="">
                    ...
                    <div
                        ...
                        <div class="form-group col-lg-6 mb-5">
                            {{ Form::label('flutterwave_key', __('messages.setting.flutterwave_key') . ':', ['class' => 'form-label razorpay-key-label mb-3']) }}
                        ...
                        <div class="form-group col-lg-6 mb-5">
                            {{ Form::label('flutterwave_secret', __('messages.setting.flutterwave_secret') . ':', ['class' => 'form-label razorpay-secret-label mb-3']) }}
