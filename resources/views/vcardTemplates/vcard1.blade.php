        ...
        <div class="vcard-one main-content  w-100 mx-auto content-blur allSection collapse show">
            ...
            <div class="vcard-one__banner w-100 position-relative">
                ...
                <video class="cover-video" loop autoplay muted  alt="background video" id="cover-video">
                    <source src="{{ $vcard->user->cover_img }}" type="video/mp4">
                </video>
                @else
                    <img src="{{ $vcard->user->cover_img }}" class="img-fluid" alt="background image" loading="lazy"/>
                @endif
            ...
            <div class="vcard-one__profile position-relative">
                <div class="avatar position-absolute top-0 start-50 translate-middle">
                    <img src="{{ $vcard->user->profile_img }}" alt="profile-img" class="rounded-circle" loading="lazy"/>
                </div>
            </div>
            {{-- profile details --}}
            <div
