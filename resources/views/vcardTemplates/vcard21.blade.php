        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-img">
            ...
            <div class="banner-section">
                ...
                <div class="banner-img">
                    ...
                    @else
                    <img src="{{ $vcard->user->cover_img }}" class="object-fit-cover w-100 h-100" loading="lazy"/>
                    @endif
                </div>
            ...
            <div class="profile-section px-40">
                <div class="card flex-row align-items-end justify-content-sm-start">
                    <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ $vcard->user->profile_img }}" class="w-100 h-100 object-fit-cover" loading="lazy"/>
                    </div>
